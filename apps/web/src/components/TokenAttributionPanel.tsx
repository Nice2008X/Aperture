...
import type { Model, ModelAdapter, WeightProvider } from "@aperture/model-ir";
import { computeTokenAttribution, computeHeadAttribution, type TokenAttributionResult, type HeadAttributionResult } from "@aperture/interpretability";
