import type { Model, ModelConfig, ModelMetadata, ModelNode, NodeType, ParameterRef, TensorSlice } from "@aperture/model-ir";
import { numElements, dtypeSize, modelSourceLabel } from "@aperture/model-ir";
