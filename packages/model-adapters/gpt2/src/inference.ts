import type { ActivationCapture, Intervention, Model, WeightProvider } from "@aperture/model-ir";
import {
  addMatrices,
  applyActivation,
...
function headsToTensor(headWeights: number[][][]): import("@aperture/model-ir").Tensor {
